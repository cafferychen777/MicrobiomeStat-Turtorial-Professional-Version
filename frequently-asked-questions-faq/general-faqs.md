...
It appears there may have been an issue with the installation. After downloading and installing, pay attention to the version numbers. The current GitHub version is 1.5.1.  If the installation of the GitHub version is unsuccessful, this issue may arise. Ensure you have installed all necessary dependencies before attempting to install from GitHub:
